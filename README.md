...
Écrivez des tests pour une fonction qui convertit une devise donnée en une autre devise. Assurez-vous que la fonction renvoie le résultat attendu et gérez les cas d'erreur.

---
## Tri de tableau

Écrivez des tests pour une fonction qui trie un tableau donné. Assurez-vous que la fonction renvoie le tableau trié comme prévu et gérez les cas d'erreur.

---

## Validation d'adresse email

Écrivez des tests pour une fonction qui valide une adresse email donnée. Assurez-vous que la fonction renvoie le résultat attendu pour des adresses valides et non valides, et gérez les cas d'erreur.

---

## Calcul de la moyenne

Écrivez des tests pour une fonction qui calcule la moyenne d'un tableau de nombres. Assurez-vous que la fonction renvoie le résultat attendu et gérez les cas d'erreur.

---

## Nombre de jours entre deux dates

Écrivez des tests pour une fonction qui calcule le nombre de jours entre deux dates données. Assurez-vous que la fonction renvoie le résultat attendu et gérez les cas d'erreur.

---

## Système de filtre de recherche

Écrivez des tests pour une implémentation d'un système de filtre de recherche. Assurez-vous que le système fonctionne comme prévu et gérez les cas d'erreur.

---

## Génération de mot de passe

Écrivez des tests pour une fonction qui génère un mot de passe aléatoire. Assurez-vous que la fonction renvoie un mot de passe aléatoire sécurisé et gérez les cas d'erreur.

---

## Nombres premiers

Écrivez des tests pour une fonction qui détermine si un nombre donné est premier. Assurez-vous que la fonction renvoie le résultat attendu et gérez les cas d'erreur.

---

## Transformation de chaîne

Écrivez des tests pour une fonction qui transforme une chaîne donnée en snake_case ou camelCase. Assurez-vous que la fonction renvoie le résultat attendu et gérez les cas d'erreur.
